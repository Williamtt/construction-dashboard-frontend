...
export const BREADCRUMB_PROJECT_SUFFIX_LABELS: Record<string, string> = {
  ...
  '/contract/project-info': '專案基本資料',
  '/contract/schedule': '工期調整',
  '/contract/management': '契約管理',
  '/contract/members': '成員與權限',
  '/files': '檔案管理',
  '/files/forms': '相關表單樣板',
  '/files/photos': '照片管理',
  '/management/wbs': 'WBS清單',
  '/management/resources': '人機料管理',
  ...
  '/construction/diary/pcces/upload': '契約工項匯入',
  '/construction/diary/pcces/excel-change': '契約變更',
  '/construction/diary/pcces/versions': '契約匯入紀錄',
